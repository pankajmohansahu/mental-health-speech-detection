...
**Live App:** https://huggingface.co/spaces/PANKAJ-MOHAN/mental-health-speech-analysis
...
| 3 - PHQ-8 Self-Screener | Validated depression questionnaire | Scoring algorithm | Clinical standard |
| 4 - AI Clinical Explanation | RAG + LLM explanation | FAISS + Groq LLaMA-3.3-70B | Contextualised |
| 5 - About & Model Details | Architecture and dataset info | - | - |
